...
[![crates.io](https://img.shields.io/crates/v/facet-macros-parse.svg)](https://crates.io/crates/facet-macros-parse)
[![documentation](https://docs.rs/facet-macros-parse/badge.svg)](https://docs.rs/facet-macros-parse)
[![MIT/Apache-2.0 licensed](https://img.shields.io/crates/l/facet-macros-parse.svg)](./LICENSE)
...
Parses Rust syntax for [facet-macros](https://github.com/facet-rs/facet/tree/main/facet-macros)
