...
fn test_reading_flat_structs() {
    ...
    let actual1: Outer = facet_json2::from_str(
    ...
    let actual2: Outer =
        facet_json2::from_str(r#"{"name":"test2","val":2,"Variant2":"ccc"}"#).unwrap();
    let expected2 = Outer {
    ...
    let actual3: Outer =
        facet_json2::from_str(r#"{"name":"test3","val":3,"Variant3":["ddd","eee"]}"#).unwrap();
    let expected3 = Outer {
