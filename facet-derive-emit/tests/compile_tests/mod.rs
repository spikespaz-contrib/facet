...
#[test]
#[cfg(not(miri))]
fn test_skip_serializing_type_mismatch_wont_compile() {
...
#[test]
#[cfg(not(miri))]
fn test_empty_rename() {
    // Define the test case
    let test = CompilationTest {
        name: "empty_rename",
        source: include_str!("./empty_rename.rs"),
        expected_errors: &["Empty string rename values are not allowed"],
    };
...
#[test]
#[cfg(not(miri))]
fn test_empty_rename_enum() {
    // Define the test case
    let test = CompilationTest {
        name: "empty_rename_enum",
        source: include_str!("./empty_rename_enum.rs"),
        expected_errors: &["Empty string rename values are not allowed"],
    };
...
#[test]
#[cfg(not(miri))]
fn test_empty_rename_enum_field() {
    // Define the test case
    let test = CompilationTest {
        name: "empty_rename_enum_field",
        source: include_str!("./empty_rename_enum_field.rs"),
        expected_errors: &["Empty string rename values are not allowed"],
    };
